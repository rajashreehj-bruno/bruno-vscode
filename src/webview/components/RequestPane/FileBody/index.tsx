...
const FileBody = ({
  ...
  const handleParamChange = (e: any, _param: any, type: any) => {
  ...
  const handleRemoveParams = (param: any) => {
    dispatch(
      deleteFile({
        paramUid: param.uid,
        itemUid: item.uid,
                  ...
                  <tr key={param.uid}>
                    <td>
                      <FilePickerEditor
                        ...
                        onChange={(path: any) => handleParamChange(
                          {
                            target: {
                              filePath: path
                            }
                    ...
                    <td>
                      <SingleLineEditor
                        ...
                        onChange={(newValue: any) => handleParamChange(
                          {
                            target: {
